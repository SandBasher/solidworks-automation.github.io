Attribute VB_Name = "HideShowReferenceGeometry"
Option Explicit

' Hide or Show Sketches, Planes, Origins and Axes
...
' Assumptions: Open SOLIDWORKS document
...
Sub main()
    ...
    Exit Sub
Fail:
    MsgBox "Macro failed: " & Err.Description, vbCritical, "Hide or Show Sketches, Planes, Origins and Axes"
End Sub
...
Private Sub RunMacro()
    ...
    hideIt = (MsgBox("Hide reference geometry? Choose No to show it.", vbYesNo + vbQuestion, "Reference geometry") = vbYes)
    model.SetUserPreferenceToggle 190, Not hideIt
    model.SetUserPreferenceToggle 191, Not hideIt
    model.SetUserPreferenceToggle 192, Not hideIt
    model.SetUserPreferenceToggle 193, Not hideIt

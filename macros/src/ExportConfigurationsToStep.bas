Attribute VB_Name = "ExportConfigurationsToStep"
Option Explicit
...
Sub main()
    ...
    Exit Sub
Fail:
    MsgBox "Macro failed: " & Err.Description, vbCritical, "Export All Configurations to STEP"
End Sub
...
Private Sub RunMacro()
    ...
    ext = IIf("export-configurations-step" = "export-configurations-step", ".step", ".stl")
